...
# Default public client ID used for device-code authentication.
# This is the Azure CLI app ID, which is commonly used for interactive user auth flows.
    ...
    def authenticate_with_device_code(self) -> bool:
        ...
        try:
            self.credential = DeviceCodeCredential(
                tenant_id=self.tenant_id,
                client_id=self.client_id  # Azure CLI client ID
            )
