...
Generates an HTML report from OIDSEE JSON export data that summarizes:
- Risk level distribution
- Top risk contributors
- Key findings and metrics
- Security recommendations

The report aligns with OIDSEE's scoring logic as documented in docs/scoring-logic.md
"""
...
def generate_html_report(export_data: Dict[str, Any], output_path: str) -> None:
    """
    Generate an HTML report from OIDSEE export data.
...
<body>
    <div class="container">
        ...
        <div class="footer">
            Generated by OID-See Scanner | For more information, visit the <a href="https://github.com/OID-See/OID-See" target="_blank">OID-See Repository</a>
        </div>
    </div>
</body>
</html>
